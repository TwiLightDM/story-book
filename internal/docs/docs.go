    ...
    "paths": {
        ...
        "/carts": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для корзины",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.CodeListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/codes/{code}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Название промо-кода",
                        "name": "code",
                        "in": "path",
                        "required": true
                    }
        ...
        "/orders": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Фильтр: начальная дата (формат YYYY-MM-DD)",
                        "name": "start_date",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Фильтр: конечная дата (формат YYYY-MM-DD)",
                        "name": "end_date",
                        "in": "query"
                    },
                    {
        ...
        "dto.OrderResponse": {
            ...
            "properties": {
                ...
                "order_books": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.OrderBooksResponse"
                    }
                },
                "points": {
                    "type": "integer"
